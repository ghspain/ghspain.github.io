...
const validIssue2 = {
  ...
  labels: [{ name: 'Event' }]
      ...
      console.log('Test 1 - Issue válido (ghspain-user):');
      console.log('Resultado:', shouldProcessIssue(validIssue) ? '✅ VÁLIDO' : '❌ RECHAZADO');
      console.log();

      console.log('Test 1b - Issue válido (alexcerezo):');
      console.log('Resultado:', shouldProcessIssue(validIssue2) ? '✅ VÁLIDO' : '❌ RECHAZADO');
      console.log();
